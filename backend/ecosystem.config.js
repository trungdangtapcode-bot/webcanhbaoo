  ...
  apps: [
    {
      ...
      env_production: {
        ...
        JAM_VEHICLE_THRESHOLD: '20',
        VOLUME_THRESHOLD_HIGH: '21',
      },
    ...
    },
    {
      ...
      env: {
        ...
        DETECTOR_TRAFFIC_MIN_VEHICLES: '21',
        ...
        DETECTOR_AI_PROVIDER: 'gemini',
        DETECTOR_AI_ENDPOINT: 'https://generativelanguage.googleapis.com/v1beta/openai/chat/completions',
        DETECTOR_AI_MODEL: 'gemini-2.5-flash',
